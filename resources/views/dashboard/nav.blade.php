    ...
    <div class="aside-left bg-white px-3 pb-2 min-vh-100 shadow">
        <ul class="menu" style="list-style-type: none">
            ...
            @component("component.nav-item-count")
                ...
                @slot("count") {{ \App\Post::get()->count() }} @endslot
            @endcomponent
            ...
            @component("component.nav-item-count")
                ...
                @slot("count") {{ \App\RequestApp::get()->count() }} @endslot
            @endcomponent
            @component('component.nav-spacer') @endcomponent
            ...
            @component("component.nav-item-count")
                ...
                @slot("count") {{ \App\Suggest::get()->count() }} @endslot
            @endcomponent
            @component('component.nav-spacer') @endcomponent

            @component("component.nav-title") Popular Management @endcomponent
