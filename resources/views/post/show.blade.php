                        ...
                        @isset($post)
                            <div class="d-flex flex-wrap justify-content-around ">
                                <div class="col-3 col-xs-12 col-md-2 px-0 my-3">
                                    <img src="{{ asset("/storage/logo/".$post->logo) }}" style="width: 100%;  margin-bottom: 5px;" alt="">
                                </div>
                            ...
                            <div class="col-12 d-flex flex-wrap g_img">
                                <h1 class="col-12 font-weight-bolder text-center my-4">Gameplay Photo</h1>
                            @foreach($post->getPhoto as $photo)
                                ...
                                @endforeach
                                    <div class="col-12 text-center my-4">
                                        <h1 class="col-12 font-weight-bolder my-4">Gameplay Video</h1>
                                        {!! $post->video !!}
                                    </div>
                                    <div class="col-12">
                                        <h1 class="col-12 font-weight-bolder my-4 text-center">Game Description</h1>
                                        {!! $post->description !!}
                                    </div>
                                <div class="col-12">
                                    <h1 class="col-12 font-weight-bolder text-center my-4">Mod Features</h1>
                                    {!! $post->features !!}
                                </div>
                            </div>
                        @endisset
