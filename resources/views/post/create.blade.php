                        ...
                        <form action="{{ route('post.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input required type="file" accept="image/png, .jpeg, .jpg, image/gif" class="form-control p-1 @error('logo') is-invalid @enderror" name="logo" id="logo" value="{{old('logo')}}" placeholder="Game Logo">
                                    @error('logo')
                                    <small class="invalid-feedback font-weight-bold" role="alert">
                                        {{ $message }}
                                    </small>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input required type="text" class="form-control @error('link1') is-invalid @enderror" name="link1" id="link1" value="{{old('link1')}}" placeholder="Link One">
                                    @error('link1')
                                    <small class="invalid-feedback font-weight-bold" role="alert">
                                        {{ $message }}
                                    </small>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="images">Game Photos</label>
                                    <input required type="file" accept="image/png, .jpeg, .jpg, image/gif" multiple class="p-1 form-control @error('images') is-invalid @enderror" name="images[]" id="images" value="{{old('images')}}">
                                    @error('images')
                                    <small class="invalid-feedback font-weight-bold" role="alert">
                                        {{ $message }}
                                    </small>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea required class="form-control @error('features') is-invalid @enderror" name="features"  id="features">{{old('features')}}</textarea>
                                    @error('features')
                                    <small class="invalid-feedback font-weight-bold" role="alert">
                                        {{ $message }}
                                    </small>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea required class="form-control @error('description') is-invalid @enderror" name="description"  id="description">{{old('description')}}</textarea>
                                    @error('description')
                                    <small class="invalid-feedback font-weight-bold" role="alert">
                                        {{ $message }}
                                    </small>
