            ...
            @foreach($games as $post)
                <div class="col-6 px-sm-2 px-md-3 px-lg-3 col-md-3 col-lg-2 my-3">
                    <div class="card game_card rounded-0"  style="cursor: pointer;">
                        <img class="card-img-top" src="{{ asset("/storage/thumbnail/".$post->logo) }}" alt="Card image cap" onclick="location.href='{{route('game.single-game-list',$post->id)}}'" style="width: 100%; height: 125px; padding: 13px;">
                        <div class="card-body pt-1 pb-2" onclick="location.href='{{route('game.single-game-list',$post->id)}}'" style="padding: 13px">
