...
@section('content')
    <div class="container py-2">
        <div class="col-12 p-0 pt-5 d-flex flex-wrap align-items-center">
            ...
            <h2 class="col-12 my-5 text-center pb-4 pt-3 text-white border border-dark" style="background: rgba(11,15,18,0.6);">Last Updated Games</h2>
            ...
            @foreach(\App\Post::inRandomOrder()->paginate(12) as $post)
                <div class="col-6 col-md-3 col-lg-2 my-3">
                    <div class="card game_card rounded-0"   style="cursor: pointer;">
                        <img class="card-img-top" src="{{ asset("/storage/thumbnail/".$post->logo) }}" onclick="location.href='{{route('game.single-game-list',$post->id)}}'" alt="Card image cap" style="width: 100%; height: 125px; padding: 13px;">
                        <div class="card-body pt-1 pb-2" style="padding: 13px" onclick="location.href='{{route('game.single-game-list',$post->id)}}'">
